        ...
        <>
                                    ...
                                    <div className='row'>
                                        <div className="col-12">
                                            <div className='contact-info-deatils'>
                                                <div >
                                                    <MdLocationPin size={40} className='contact-icons' />
                                                </div>
                                        ...
                                        <div className='col-12'>
                                            ...
                                            <div className=' online-platforms'>
                                                <div className=""><PiFacebookLogoBold size={30} /></div>
                                                <div className=""><BsInstagram size={30} /></div>
                                                <div className=""><BsPinterest size={30} /></div>
                                                <div className=""><AiFillLinkedin size={30} /></div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div className='prop-location-map'>
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3666.2756631211932!2d69.64143297622796!3d23.233053779026758!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3950e1e328911c2f%3A0xd3fbdee849719bee!2sShree%20Softech!5e0!3m2!1sen!2sin!4v1689831653200!5m2!1sen!2sin"
                    style={{
                        width: "100%", height: "600px", style: "border:0", allowFullScreen: "", loading: "lazy", referrerpolicy: "no-referrer-when-downgrade",
                        borderRadius: "12px"
